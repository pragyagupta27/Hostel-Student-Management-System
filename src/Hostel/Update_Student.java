...
class Update_Student extends Add_Student implements ActionListener{
    ...
    Update_Student(String idaa){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hostel/icons/add_employee.jpg"));
        id15.setIcon(img);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',room_num='"+t7.getText()+"',aadhar='"+t8.getText()+"',stu_id='"+t9.getText()+"' where stu_id='"+id_emp+"'";
