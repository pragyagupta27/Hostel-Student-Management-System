...
class Print_Data implements ActionListener{
    ...
    String stu_id,name,fname,address,phone,email,education,roomnum,age,dob,aadhar;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hostel/icons/print.jpg"));
        id9.setIcon(img);
